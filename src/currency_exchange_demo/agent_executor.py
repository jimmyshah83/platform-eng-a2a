"""Currency exchange demo agent executor module.

This module contains the CurrencyAgentExecutor class that handles
currency conversion requests and manages task execution flow.
"""
import logging
