"""GitHub MCP demo agent executor module.

This module contains the GitHubMCPAgentExecutor class that handles
GitHub MCP requests and manages task execution flow.
"""
import logging
...
class GitHubMCPAgentExecutor(AgentExecutor):
    """GitHub MCP AgentExecutor Example."""

    def __init__(self):
        self.agent = GitHubMCPAgent()
